...
bool SearchInRange(Node *root, const char *key1, const char* key2);
bool SearchInRangeAge(Node* node, const char* key1, const char* key2, vector<int> age, database Nbligne);
